...
# Using the home_town dictionary, assign to a variable named home_town_message 
# a string with this format: “I was born in <city>, <state> - population of <population>”

def hometown_info():
    home_town = {"city": "San Francisco", "state": "California", "population": 700000 }
